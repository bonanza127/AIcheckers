#!/usr/bin/env python3
"""
28d + niji7 Two-Head モデル学習スクリプト
28dと同じ設定で、niji7_twitter_aiだけを追加
"""
...
MODEL_DIR = Path('models/two_head_28d_niji7')
...
def main():
    print("=" * 60)
    print("Two-Head 28d + niji7 Model Training")
    print("Same settings as 28d, only added niji7_twitter_ai")
    ...
    config = {
        ...
        "notes": "28d + niji7_twitter_ai only"
    }
