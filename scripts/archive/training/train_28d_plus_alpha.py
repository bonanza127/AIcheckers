#!/usr/bin/env python3
"""
28d_plus_alpha: 28d_plusのデータで28dの学習条件を使用
学習条件の差異を検証するための実験
"""
...
MODEL_DIR = Path('models/two_head_28d_plus_alpha')
...
def main():
    print("=" * 60)
    print("Two-Head 28d_plus_alpha Training")
    print("Data: 28d_plus categories, Settings: 28d identical")
    ...
    config = {
        "version": "28d_plus_alpha",
        "gpu_dim": 4, "cpu_dim": 24,
        "training_categories": AI_CATEGORIES,
        "pr_auc": float(early_stopping.best_score),
        "best_epoch": early_stopping.best_epoch,
        "notes": "28d_plus data with 28d training settings (for comparison)"
    }
