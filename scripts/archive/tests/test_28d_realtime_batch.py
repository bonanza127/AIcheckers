#!/usr/bin/env python3
"""
28d Model Real-time Scan Test - Batched Version
"""
import sys
...
# Config
MODEL_DIR = Path("/home/techne/aicheckers/models/two_head_28d")
DINOV3_PATH = Path("/home/techne/aicheckers/models/dinov3-vitb16")
MID_LAYER = 6

# Feature indices (28d model)
GPU_4D_IDX = [1, 3, 5, 6]  # adj_sim_var, patch_var, norm_var, norm_range
CPU16_12D_IDX = [0, 1, 2, 4, 7, 8, 9, 11, 12, 13, 14, 15]  # patchwise_edge_density[5] removed
CPU20_11D_IDX = [0, 1, 2, 3, 4, 5, 8, 10, 15, 16, 17]  # edge_continuity_ratio[18] removed

STD_FLOOR = 1e-3


class TwoHeadClassifier(nn.Module):
    def __init__(self, cls_dim=768, gpu_dim=5, cpu_dim=23, hidden_dim=256):
        super().__init__()
...
def main():
    ...
    # Load model
    print("Loading 28d model...")
    model = TwoHeadClassifier(cls_dim=768, gpu_dim=5, cpu_dim=23).to(device)
    ...
    print("\n" + "=" * 60)
    print(f"28d Model Batch Scan Results")
    print("=" * 60)
