      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-10">
          ...
          <p className="text-muted text-lg">
            ...
            複数の技法をかけ合わせた<span className="text-accent font-bold">Moonknight V1.3.6</span>により、生成AIの学習を顕著に妨害します。
          </p>
          ...
          <div className="w-full lg:w-2/3 flex flex-col gap-6">
                  ...
                  {currentProtectedImage ? (
                    ...
                    <div className="w-full h-48 md:h-72 flex flex-col items-center justify-center bg-black/10 rounded-lg border border-dashed border-gray-700">
                      {phase === "scanning" ? (
                        ...
                        <p className="text-muted font-light tracking-widest text-lg">After</p>
                      )}
                    </div>
                  )}
            ...
            <div className="card-panel p-6 relative">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap sm:justify-between items-start sm:items-center mb-4 text-sm text-muted gap-2">
                ...
                <span>使用モデル: <span className="text-accent font-bold">Moonknight V1.3.6</span></span>
